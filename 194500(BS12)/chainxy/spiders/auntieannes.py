...
class auntieannes(scrapy.Spider):
	...
	def start_requests(self):
		...
		for location in self.location_list:
			payload = '<request><appkey>6B95F8A2-0C8A-11DF-A056-A52C2C77206B</appkey><formdata id="locatorsearch"><dataview>store_default</dataview><limit>500</limit><geolocs><geoloc><addressline>'+location['city']+'</addressline><longitude></longitude><latitude></latitude><country>US</country></geoloc></geolocs><where><or><hascatering><eq></eq></hascatering><haspretzelfieldtrip><eq></eq></haspretzelfieldtrip><newstores><eq></eq></newstores></or></where><searchradius>1000</searchradius><stateonly>1</stateonly></formdata></request>'

...
class wilsonautoelectric(scrapy.Spider):
	name = 'wilsonautoelectric'
	domain = ''
	history = []
	...
	def start_requests(self):
		init_url = 'http://www.bullseyelocations.com/pages/Default?f=1'
		...
		formdata = {
			...
			"__ASYNCPOST":"true",
			"ctl00$ContentPlaceHolder1$searchButton2":"Search",
		}

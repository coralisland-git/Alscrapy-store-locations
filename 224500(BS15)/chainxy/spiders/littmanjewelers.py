...
class littmanjewelers(scrapy.Spider):
	name = 'littmanjewelers'
	domain = ''
	history = []
	...
	def start_requests(self):
		for location in self.location_list:
			init_url = 'https://www.littmanjewelers.com/Service/storelocatorhandler.ashx?action=FindStores&zipCode=&city='+location['city']+'&state='+self.get_state(location['state'])+'&radius=100'
			header = {

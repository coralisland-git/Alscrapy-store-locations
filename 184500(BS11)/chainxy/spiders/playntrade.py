...
class playntrade(scrapy.Spider):
	name = 'playntrade'
	domain = ''
	history = []

	def start_requests(self):
		init_url = 'https://www.hourscenter.com/play-n-trade/'
		yield scrapy.Request(url=init_url, callback=self.body) 

	def body(self, response):
		print("=========  Checking.......")
		state_list = response.xpath('//div[@class="cities"]//ul[@class="state_list"]//li//a/@href').extract()

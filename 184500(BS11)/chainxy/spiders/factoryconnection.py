...
class factoryconnection(scrapy.Spider):
	...
	def start_requests(self):
		init_url = 'http://www.factory-connection.com/find-a-store'
	...
	def body(self, response):
		...
		for location in self.location_list:
			...
			self.driver.find_element_by_id('state').send_keys(location['name'])
			self.driver.find_element_by_xpath('//form[@action="http://www.factory-connection.com/find-a-store/by-state"]//button[@class="btn btn-primary btn-sm"]').click()

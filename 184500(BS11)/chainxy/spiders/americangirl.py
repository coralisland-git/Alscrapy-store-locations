...
class americangirl(scrapy.Spider):
	name = 'americangirl'
	domain = 'http://www.americangirl.com'
	history = []
	...
	def start_requests(self):
		init_url = 'http://www.americangirl.com/retail/'
		yield scrapy.Request(url=init_url, callback=self.body)
	
	def body(self, response):
		self.driver.get("http://www.americangirl.com/retail/boston.php")

...
class centinelafeed(scrapy.Spider):
	name = 'centinelafeed'
	domain = ''
	history = []
	...
	def start_requests(self):
		init_url = 'http://www.centinelafeed.com/about-us/contact-information/'
		yield scrapy.Request(url=init_url, callback=self.body)
	
	def body(self, response):
		self.driver.get("http://www.centinelafeed.com/about-us/contact-information/")

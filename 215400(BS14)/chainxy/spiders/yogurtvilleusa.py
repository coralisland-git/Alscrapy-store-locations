...
class yogurtvilleusa(scrapy.Spider):
	name = 'yogurtvilleusa'
	domain = ''
	history = []

	def start_requests(self):
		init_url = 'https://www.hourscenter.com/yogurtville/'
		yield scrapy.Request(url=init_url, callback=self.parse_city) 

	def parse_city(self, response):
		print("=========  Checking.......")
		city_list = response.xpath('//div[@class="cities"]//ul[@class="state_list"]//a/@href').extract()

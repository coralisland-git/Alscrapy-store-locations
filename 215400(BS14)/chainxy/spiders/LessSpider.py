...
class lessspider(scrapy.Spider):
    name = 'lessmy'
    domain = ''
    history = []
    ...
    def start_requests(self):
        init_url = 'https://www.food4less.com'
        header = {
            "accept":"*/*",
        ...
        yield scrapy.Request(url=init_url,headers=header, callback=self.body, meta={'proxy':'https://40.71.211.132:3128'})

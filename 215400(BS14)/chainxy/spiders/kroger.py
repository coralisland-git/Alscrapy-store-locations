...
class kroger(scrapy.Spider):
	...
	def start_requests(self):
		init_url = 'https://www.kroger.com/stores/api/graphql'
		header = {
			"accept":"*/*",
			"accept-encoding":"gzip, deflate, br",
			"content-type":"application/json"
		}
		payload = {"query":"query storeSearch($searchText: String!, $filters: [String]!) {storeSearch(searchText: $searchText, filters: $filters) { stores {...storeSearchResult  }   fuel { ...storeSearchResult  }  shouldShowFuelMessage  } } fragment storeSearchResult on Store {  banner  vanityName  divisionNumber  storeNumber  phoneNumber  showWeeklyAd  showShopThisStoreAndPreferredStoreButtons\n  distance\n  latitude\n  longitude\n  address {\n    addressLine1\n    addressLine2\n    city\n    countryCode\n    stateCode\n    zip\n  }\n  pharmacy {\n    phoneNumber\n  }\n}\n",
			"variables":'{"searchText":"90001","filters":[]}',

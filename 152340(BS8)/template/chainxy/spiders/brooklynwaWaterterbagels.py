...
class brooklynwaWaterterbagels(scrapy.Spider):
	name = 'brooklynwaWaterterbagels'
	domain = ''
	history = []

	def start_requests(self):
		init_url = 'http://www.originalbrooklynwaterbagel.com/wp-content/plugins/store-locator/sl-xml.php'
	...
	def validate(self, item):
		try:
			return item.extract_first().strip().replace(';', '').replace('Phone:', '')
		except:
			return ''
